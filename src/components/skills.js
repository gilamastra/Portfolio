...
import { FaCss3, FaDatabase, FaGit, FaGitAlt, FaJs, FaWordpress, FaWordpressSimple } from 'react-icons/fa';
        ...
        <div className="container  ">
            ...
            < div className = " row text-center mt-5 " >
                <div className="col-sm-4 mt-5 ">
                    ...
                    <p className="skills-iconSubTitle">Semantic</p>
                </div>
                <div className="col-sm-4 mt-5">
                    <FaCss3 className="skills-icon"/>
                    <p className="skills-iconTitle">CSS-3</p>
                     <p className="skills-iconSubTitle">Bootstrap, Materialize</p>
                ...
                <div className="col-sm-4 mt-5">
                    ...
                    <p className="skills-iconSubTitle">React, React Native, Node.js</p>
            ...
            < div className = "row text-center mt-5 " >
                <div className="col-sm-4 mb-5  ">
                    <FaDatabase className="skills-icon"/>
                     <p className="skills-iconSubTitle">MySQL</p>
